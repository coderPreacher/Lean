...
namespace QuantConnect.Tests.Algorithm.Framework.Portfolio
{
    ...
    public class PortfolioTargetTests
    {
        ...
        [Test]
        public void PercentReturnsExistingHoldingsIfPriceIsZero()
        {
            const decimal holdings = 50;
            ...
            Assert.AreEqual(security.Symbol, target.Symbol);
            Assert.AreEqual(holdings, target.Quantity);
        }

        [Test]
        public void PercentReturnsExistingHoldingsIfBuyingPowerModelError()
        {
            const decimal holdings = 50;
            const decimal targetPercent = 1m;
